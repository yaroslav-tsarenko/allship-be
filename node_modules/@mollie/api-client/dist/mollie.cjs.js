...
function resolveIf(value) {
  var _runIf;
  return (_runIf = ruply.runIf(value, Promise.resolve)) !== null && _runIf !== void 0 ? _runIf : value;
}
...
class OrderHelper extends Helper {
  ...
  getPayments() {
    ...
    return (_runIf = ruply.runIf((_this$embedded = this.embedded) === null || _this$embedded === void 0 ? void 0 : _this$embedded.payments, Promise.resolve)) !== null && _runIf !== void 0 ? _runIf :
  ...
  getShipments() {
    ...
    // below constructs its own URL. If the Mollie API ever starts to return such a link, use it instead for
    // consistency.
    return (_runIf3 = ruply.runIf((_this$embedded3 = this.embedded) === null || _this$embedded3 === void 0 ? void 0 : _this$embedded3.shipments, Promise.resolve)) !== null && _runIf3 !== void 0 ? _runIf3 : this.networkClient.list(getPathSegments$h(this.id), 'shipments');
  }
}
