...
function resolveIf(value) {
  var _runIf;
  return (_runIf = runIf(value, Promise.resolve)) !== null && _runIf !== void 0 ? _runIf : value;
}
...
class RefundHelper extends Helper {
  ...
  getOrder() {
    ...
    return (_runIf = runIf(this.links.order, ({
      href
    }) => this.networkClient.get(href))) !== null && _runIf !== void 0 ? _runIf : undefinedPromise;
  }
}
...
class CaptureHelper extends Helper {
  ...
  getSettlement() {
    ...
    return (_runIf2 = runIf(this.links.settlement, ({
      href
    }) => this.networkClient.get(href))) !== null && _runIf2 !== void 0 ? _runIf2 : undefinedPromise;
  }
}
...
class PaymentHelper extends Helper {
  ...
  getRefunds(parameters) {
    ...
    return (_ref = (_runIf = runIf((_this$embedded = this.embedded) === null || _this$embedded === void 0 ? void 0 : _this$embedded.refunds, refunds => new HelpfulIterator(makeAsync(refunds[Symbol.iterator]())))) !== null && _runIf !== void 0 ? _runIf : runIf(this.links.refunds, ({
      href
    }) => this.networkClient.iterate(href, 'refunds', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute))) !== null && _ref !== void 0 ? _ref : emptyHelpfulIterator;
  }
  ...
  getChargebacks(parameters) {
    ...
    return (_ref2 = (_runIf2 = runIf((_this$embedded2 = this.embedded) === null || _this$embedded2 === void 0 ? void 0 : _this$embedded2.chargebacks, chargebacks => new HelpfulIterator(makeAsync(chargebacks[Symbol.iterator]())))) !== null && _runIf2 !== void 0 ? _runIf2 : runIf(this.links.chargebacks, ({
      href
    }) => this.networkClient.iterate(href, 'chargebacks', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute))) !== null && _ref2 !== void 0 ? _ref2 : emptyHelpfulIterator;
  }
  ...
  getCaptures(parameters) {
    ...
    return (_ref3 = (_runIf3 = runIf((_this$embedded3 = this.embedded) === null || _this$embedded3 === void 0 ? void 0 : _this$embedded3.captures, captures => new HelpfulIterator(makeAsync(captures[Symbol.iterator]())))) !== null && _runIf3 !== void 0 ? _runIf3 : runIf(this.links.captures, ({
      href
    }) => this.networkClient.iterate(href, 'captures', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute))) !== null && _ref3 !== void 0 ? _ref3 : emptyHelpfulIterator;
  }
  ...
  getOrder() {
    ...
    return (_runIf4 = runIf(this.links.order, ({
      href
    }) => this.networkClient.get(href))) !== null && _runIf4 !== void 0 ? _runIf4 : undefinedPromise;
  }
}
...
class CustomerHelper extends Helper {
  ...
  getMandates(parameters) {
    ...
    return (_runIf = runIf(this.links.mandates, ({
      href
    }) => this.networkClient.iterate(href, 'mandates', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute))) !== null && _runIf !== void 0 ? _runIf : emptyHelpfulIterator;
  }
  ...
  getSubscriptions(parameters) {
    ...
    return (_runIf2 = runIf(this.links.subscriptions, ({
      href
    }) => this.networkClient.iterate(href, 'subscriptions', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute))) !== null && _runIf2 !== void 0 ? _runIf2 : emptyHelpfulIterator;
  }
  ...
  getPayments(parameters) {
    ...
    return (_runIf3 = runIf(this.links.payments, ({
      href
    }) => this.networkClient.iterate(href, 'payments', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute))) !== null && _runIf3 !== void 0 ? _runIf3 : emptyHelpfulIterator;
  }
}
...
class SubscriptionHelper extends Helper {
  ...
  getPayments(parameters) {
    ...
    return (_runIf2 = runIf(this.links.payments, ({
      href
    }) => this.networkClient.iterate(href, 'payments', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute))) !== null && _runIf2 !== void 0 ? _runIf2 : emptyHelpfulIterator;
  }
}
...
class OrderHelper extends Helper {
  ...
  getPayments() {
    var _runIf, _this$embedded;
    if (renege(this, this.getPayments, ...arguments)) return;
    return (_runIf = runIf((_this$embedded = this.embedded) === null || _this$embedded === void 0 ? void 0 : _this$embedded.payments, Promise.resolve)) !== null && _runIf !== void 0 ? _runIf :
  ...
  getRefunds(parameters) {
    ...
    // consistency.
    return (_runIf2 = runIf((_this$embedded2 = this.embedded) === null || _this$embedded2 === void 0 ? void 0 : _this$embedded2.refunds, refunds => new HelpfulIterator(makeAsync(refunds[Symbol.iterator]())))) !== null && _runIf2 !== void 0 ? _runIf2 : this.networkClient.iterate(getPathSegments$g(this.id), 'refunds', undefined, parameters === null || parameters === void 0 ? void 0 : parameters.valuesPerMinute);
  }
  ...
  getShipments() {
    ...
    // below constructs its own URL. If the Mollie API ever starts to return such a link, use it instead for
    // consistency.
    return (_runIf3 = runIf((_this$embedded3 = this.embedded) === null || _this$embedded3 === void 0 ? void 0 : _this$embedded3.shipments, Promise.resolve)) !== null && _runIf3 !== void 0 ? _runIf3 : this.networkClient.list(getPathSegments$h(this.id), 'shipments');
  }
}
...
class ProfileHelper extends Helper {
  ...
  getMethods() {
    ...
    return (_runIf2 = runIf(this.links.methods, ({
      href
    }) => this.networkClient.list(href, 'methods'))) !== null && _runIf2 !== void 0 ? _runIf2 : Promise.resolve([]);
  }
...
export { ApiMode, CaptureInclude, CaptureMethod, CaptureStatus, HistoricPaymentMethod, Locale, MandateMethod, MandateStatus, MethodImageSize, MethodInclude, ApiError as MollieApiError, OnboardingStatus, OrderEmbed, OrderLineType, OrderStatus, PaymentEmbed, PaymentInclude, PaymentMethod, PaymentStatus, ProfileStatus, RefundEmbed, RefundStatus, SequenceType, SubscriptionStatus, createMollieClient, createMollieClient as default };
