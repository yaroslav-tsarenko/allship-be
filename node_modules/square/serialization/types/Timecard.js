...
const TimecardWage_1 = require("./TimecardWage");
const Break_1 = require("./Break");
const TimecardStatus_1 = require("./TimecardStatus");
const Money_1 = require("./Money");
exports.Timecard = core.serialization.object({
    ...
    wage: TimecardWage_1.TimecardWage.optional(),
    breaks: core.serialization.list(Break_1.Break).optionalNullable(),
    status: TimecardStatus_1.TimecardStatus.optional(),
    ...
    declaredCashTipMoney: core.serialization.property("declared_cash_tip_money", Money_1.Money.optional()),
});
